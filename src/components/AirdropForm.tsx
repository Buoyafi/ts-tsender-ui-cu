...
export default function AirdropForm({ isUnsafeMode, onModeChange }: AirdropFormProps) {
    ...
    async function getApprovedAmount(tSenderAddress: string | null): Promise<number> {
        ...
        // read from the chain to see if we have appreoved enough token
        ...
        >
            ...
            <div>
                ...
                <button
                    ...
                    className="relative bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
                    {/* Gradient */}
